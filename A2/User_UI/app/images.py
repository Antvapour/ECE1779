...
def s3_upload():
    ...
    for upload in request.files.getlist("file"):
        ...
        s3 = boto3.client('s3')
        s3.upload_fileobj(upload, 'imagesece1779', filename, ExtraArgs={"ContentType": "image/jpeg"})
        ...
        url = s3.generate_presigned_url(
            'get_object',
            Params={'Bucket': 'imagesece1779', 'Key': filename})
        ...
        with Image(file=urllib.request.urlopen(url)) as img:
            ...
            with img.clone() as thumb:
                ...
                s3 = boto3.client('s3')
                s3.upload_fileobj(bytes_io_file, 'imagesece1779', filename + '_thumbnail',
            ...
            with img.clone() as rotated:
                ...
                s3 = boto3.client('s3')
                s3.upload_fileobj(bytes_io_file, 'imagesece1779', filename + '_rotated',
                                  ExtraArgs={"ContentType": "image/jpeg"})
            ...
            with img.clone() as flopped:
                ...
                s3 = boto3.client('s3')
                s3.upload_fileobj(bytes_io_file, 'imagesece1779', filename + '_flopped',
                                  ExtraArgs={"ContentType": "image/jpeg"})
            ...
            with img.clone() as gray:
                ...
                s3 = boto3.client('s3')
                s3.upload_fileobj(bytes_io_file, 'imagesece1779', filename + '_gray',
                                  ExtraArgs={"ContentType": "image/jpeg"})
